...
//
// tmess HTTP server encoders and decoders
//
// Command:
...
// EncodeLoginResponse returns an encoder for responses returned by the tmess
// login endpoint.
...
// DecodeLoginRequest returns a decoder for requests sent to the tmess login
// endpoint.
...
// EncodeLoginError returns an encoder for errors returned by the login tmess
// endpoint.
...
// DecodeEchoerRequest returns a decoder for requests sent to the tmess echoer
// endpoint.
...
// EncodeEchoerError returns an encoder for errors returned by the echoer tmess
// endpoint.
...
// DecodeListenerRequest returns a decoder for requests sent to the tmess
// listener endpoint.
...
// DecodeSummaryRequest returns a decoder for requests sent to the tmess
// summary endpoint.
...
// DecodeSubscribeRequest returns a decoder for requests sent to the tmess
// subscribe endpoint.
...
// DecodeHistoryRequest returns a decoder for requests sent to the tmess
// history endpoint.
