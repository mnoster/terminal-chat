...
import (
	...
	"fmt"
	"os"
	tmessc "terminal-chat/gen/grpc/tmess/client"
...
Example:
    `+os.Args[0]+` tmess echoer --token "Porro et."
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` tmess listener --token "Nihil laudantium."
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` tmess summary --token "Possimus aut iste id."
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` tmess subscribe --token "Laborum totam ratione amet sunt est."
`, os.Args[0])
}
...
Example:
    `+os.Args[0]+` tmess history --view "Illum ut tenetur architecto ea aperiam." --token "Sunt rerum minus sed."
`, os.Args[0])
}
