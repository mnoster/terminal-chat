...
// Endpoints wraps the "tmess" service endpoints.
...
// NewEndpoints wraps the methods of the "tmess" service with endpoints.
...
// Use applies the given middleware to all the "tmess" service endpoints.
