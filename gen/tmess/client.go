...
// Client is the "tmess" service client.
type Client struct {
...
// NewClient initializes a "tmess" service client given the endpoints.
...
// Login calls the "login" endpoint of the "tmess" service.
...
// Echoer calls the "echoer" endpoint of the "tmess" service.
...
// Listener calls the "listener" endpoint of the "tmess" service.
...
// Summary calls the "summary" endpoint of the "tmess" service.
...
// Subscribe calls the "subscribe" endpoint of the "tmess" service.
...
// History calls the "history" endpoint of the "tmess" service.
