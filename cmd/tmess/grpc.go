...
import (
	...
	tmesssvr "terminal-chat/gen/grpc/tmess/server"
...
func handleGRPCServer(ctx context.Context, u *url.URL, tmessEndpoints *tmess.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	{
		tmessServer = tmesssvr.New(tmessEndpoints, nil, nil)
	}
	...
	tmesspb.RegisterTmessServer(srv, tmessServer)
